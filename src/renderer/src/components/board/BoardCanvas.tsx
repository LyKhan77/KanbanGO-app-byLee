...
import { Search, Plus, Filter, Sparkles, Feather, Layout, Calendar as CalendarIcon } from 'lucide-react';
    ...
    <div className="flex-1 flex flex-col h-[calc(100vh-40px)] overflow-hidden bg-boho-linen select-none">
      ...
      <div className="p-4 pb-3 bg-white/70 border-b border-boho-canvas flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-3">
          ...
          {/* View Mode Switcher */}
          <div className="flex items-center bg-boho-canvas/60 p-0.5 rounded-lg border border-boho-canvas/80 text-xs ml-2">
            <button
              type="button"
        ...
        {/* Filters and Search Bar (Kanban mode only) */}
        {viewMode === 'kanban' && (
      ...
      {/* Main Content Area: Calendar View or Kanban DragDrop Canvas */}
      {viewMode === 'calendar' ? (
